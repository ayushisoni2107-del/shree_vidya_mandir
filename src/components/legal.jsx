...
function Legal() {
  return (
    <section className="py-16 bg-white text-center">
      {/* Heading */}
      <h1 className="text-6xl font-bold md:font-serif mb-4">
        55 Years of Legacy
      </h1>
      ...
      <div className="flex items-center justify-center gap-8">
        ...
        <div className="flex flex-col items-center">
          <div className="w-40 h-40 rounded-full border-4 border-blue-600 flex items-center justify-center overflow-hidden mb-2">
            <img
              src="old-logo.jpg"
              alt="1969 Logo"
        ...
        {/* 2024 */}
        <div className="flex flex-col items-center">
          <div className="dotted-solid-border flex items-center justify-center">
          <div className="w-40 h-40 rounded-full border-4 border-blue-600 flex items-center justify-center overflow-hidden mb-2">
            <img
              src="logo.png"
              alt="2024 Logo"
